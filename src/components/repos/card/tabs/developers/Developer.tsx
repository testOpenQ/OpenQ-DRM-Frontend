...
export default function Contributor({
  ...
  if (!user || !evaluation || !evaluation.result) return null;
    ...
    <div key={user.login} className="flex items-center">
      ...
      <div className="flex flex-col">
        ...
        <div className="flex items-center space-x-1">
          ...
          <span className="text-xs text-gray-400">
            {user.followersCount + evaluation.result.followersFollowerCount}
          </span>
        </div>
      </div>
      ...
      <div className="ml-auto grid grid-cols-4 gap-3 opacity-30">
        ...
        <div>
          {user.website && (
            <Link
              href={"https://" + user.website.replace(/https?:\/\//g, "")}
              target="_blank"
            >
