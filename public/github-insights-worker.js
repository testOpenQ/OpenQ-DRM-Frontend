...
var homepage =
  "https://github.com/mktcode/lib/tree/master/packages/github-insights#readme";
var dependencies = {
  "@mktcodelib/graphql-fetch-all": "workspace:^0.5.0",
  "@octokit/core": "^4.2.0",
...
class Db extends Dexie$1 {
  constructor() {
    super(`github-insights-${pkg.version}`);
...
onmessage = (event) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (type === "scan-update") {
      const { scanId, data, variables, paginators, done, updatedAt } = payload;
